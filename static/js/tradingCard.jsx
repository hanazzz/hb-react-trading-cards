...
ReactDOM.render(
  <TradingCard name="Polymorphism" skill="stealing food" imgUrl="/static/img/polymorphism.jpeg" />,
  document.querySelector("#polymorphism"),
);

ReactDOM.render(
  <TradingCard name="Shortstack-Overflow" skill="jumping high" imgUrl="/static/img/shortstack-overflow.jpeg" />,
